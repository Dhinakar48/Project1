  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-stone-50 via-stone-100 to-amber-50 pt-10 pb-20 font-sans">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* ── Title ── */}
        <h1 className="text-4xl md:text-5xl font-black text-stone-900 tracking-tighter leading-none mb-1">
          Shopping Cart
        </h1>
                ...
                cart.map((item) => (
                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <h2 className="text-lg font-black text-stone-900 tracking-tight leading-snug mb-3">
                        {item.name}
                      </h2>
          ...
          <div>
            <div className="bg-white shadow-sm border border-stone-200 rounded-2xl p-8 relative overflow-hidden">
              ...
              <div className="relative z-10">
                <p className="text-2xl font-black italic uppercase tracking-tight text-stone-900 pb-4 mb-6 border-b border-stone-900/15">
                  Order Summary
                </p>
