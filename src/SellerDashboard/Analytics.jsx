  ...
  return (
    <div className="space-y-12 animate-in fade-in zoom-in-95 duration-1000">
      ...
      <div className="bg-white rounded-[2.5rem] border border-stone-100 p-6 md:p-8 relative overflow-hidden group shadow-sm">
         <div className="absolute top-0 right-0 w-64 h-64 bg-amber-500/5 rounded-full blur-[80px] pointer-events-none group-hover:bg-amber-500/10 transition-colors duration-1000 -mr-20 -mt-20" />
            ...
            <div className="space-y-3">
               ...
               <div className="flex gap-3">
                 ...
                 <div className="flex items-center gap-2 bg-stone-50 px-3 py-1.5 rounded-lg border border-stone-100">
                    ...
                    <span className="text-[9px] font-semibold text-stone-500">Net</span>
                 </div>
               </div>
            </div>
                   ...
                   <div key={i} className="flex-1 flex flex-col items-center gap-2 h-full justify-end group/bar cursor-pointer">
                      <div className="w-full relative flex items-end justify-center h-[85%]">
                         ...
                         <motion.div 
                           ...
                           className="absolute bottom-0 w-[80%] max-w-[32px] bg-stone-100 rounded-t-md transition-colors group-hover/bar:bg-stone-200"
                         />
                         {/* Net Bar (shorter front) */}
                         <motion.div 
                           initial={{ height: 0 }} 
                           animate={{ height: `${val * 0.65}%` }} 
                           transition={{ duration: 1.2, delay: (i * 0.1) + 0.2, type: "spring", bounce: 0.3 }}
                           className={`absolute bottom-0 w-[50%] max-w-[16px] bg-amber-500 rounded-t-sm shadow-sm group-hover/bar:bg-amber-400 group-hover/bar:shadow-md transition-all z-10`}
                         />
