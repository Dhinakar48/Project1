  ...
  return (
    <div className="space-y-8 animate-in slide-in-from-bottom duration-700">
      <div className="space-y-2">
        <h1 className="text-4xl font-black text-stone-900 italic uppercase">Customer Reviews</h1>
      </div>
      ...
      <div className="bg-white rounded-[2.5rem] border border-stone-100 shadow-2xl shadow-stone-200/40 overflow-hidden relative">
        ...
        <div className="divide-y divide-stone-50 relative z-10">
          {[
            { user: 'Marcus Aurelius', rating: 5, comment: 'Exceptional build quality on the Vertex Pro 16. The thermal performance is industry-leading.', date: '2h ago', product: 'Vertex Pro 16', img: '/computing/laptop1.jpg' },
            { user: 'Sophia Loren', rating: 4, comment: 'Quantum Watch X is beautiful, but the battery synchronization could be tighter.', date: '5h ago', product: 'Quantum Watch X', img: '/wearables/watch1.jpg' },
            { user: 'Elena Gilbert', rating: 5, comment: 'The Sonic Buds Pro offer unparalleled noise cancellation protocol.', date: '1d ago', product: 'Sonic Buds Pro', img: '/audios/buds1.jpg' },
          ].map((rev, i) => (
            <div key={i} className="p-8 hover:bg-stone-50 transition-colors flex flex-col lg:flex-row gap-8">
              <div className="w-20 h-20 flex-shrink-0 bg-stone-50 rounded-2xl border border-stone-100 overflow-hidden shadow-sm group cursor-pointer p-2">
                 <img src={rev.img} alt={rev.product} className="w-full h-full object-contain group-hover:scale-110 transition-transform duration-700" />
              </div>
