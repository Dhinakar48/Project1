        ...
        <div className="min-h-screen bg-stone-50 py-16 px-6 md:px-16 lg:px-24">
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-16">
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter uppercase italic text-stone-900 border-b-4 border-stone-900 pb-4 inline-block">
                        {categoryName}
                    </h1>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12">
                    {filteredProducts.length > 0 ? (
                        filteredProducts.map((product) => (
                            ...
                            >
                                ...
                                <div className="space-y-1">
                                    ...
                                    <p className="text-sm font-black text-stone-500 uppercase tracking-widest italic pt-1">
                        ...
                        <div className="col-span-full py-20 text-center">
                            <p className="text-stone-400 font-medium italic">No products found for this category.</p>
                        </div>
                    )}
                </div>
            </div>
